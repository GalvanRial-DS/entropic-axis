...
studies_dsw = {
    "Anaesthesia": {
        ...
        "conditions": {
            "anestesia_block2": {"label": "Light Anaesthesia", "dx": -0.5, "dy": -0.2},
    ...
    "Modafinil": {
        ...
        "conditions": {
            "modafinil_condition1": {"label": "Modafinil", "dx": 0.15, "dy": 0.15},
        },
    },
    "Schizophrenia": {
...
studies_tian_dsw = {
    "Anaesthesia": {
        ...
        "conditions": {
            "anestesia_light": {"label": "Light Anaesthesia", "dx": -0.5, "dy": -0.2},
...
def plot_2d(stats_df, output_tag):
    ...
    # Better label offsets to prevent overlaps with lines and each other
    label_offsets = {
        "Light Anaesthesia": {"dx": -0.1, "dy": 0.05, "ha": "right", "va": "bottom"},
        "Deep": {"dx": -0.05, "dy": -0.15, "ha": "right", "va": "top"},
        "LSD": {"dx": 0.05, "dy": 0.1, "ha": "left", "va": "bottom"},
        "DMT": {"dx": -0.1, "dy": 0.1, "ha": "right", "va": "bottom"},
        "Modafinil": {"dx": 0.1, "dy": 0.05, "ha": "left", "va": "center"},
        "Schizophrenia": {"dx": 0.1, "dy": -0.05, "ha": "left", "va": "top"},
    }
    ...
    for _, row in stats_df.iterrows():
        ...
        # Get offset and alignment for this specific label
        offset = label_offsets.get(label, {"dx": 0.1, "dy": 0.1, "ha": "left", "va": "bottom"})
        dx, dy = offset["dx"], offset["dy"]
        ha, va = offset["ha"], offset["va"]

        # Label
        ax.text(x + dx, y + dy, label,
                color=color, fontweight="bold", fontsize=15, ha=ha, va=va)
