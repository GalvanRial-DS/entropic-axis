...
% External toolboxes (adjust paths as needed)
addpath('/path/to/SWP(1)'); 
addpath('/path/to/sampen/matlab/1.1-1');
...
% Load Yeo 7-Networks Look-Up Table
...
disp('LONO Calculation complete.');
